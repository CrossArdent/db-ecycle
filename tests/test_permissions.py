from models import ON_HOLD, RELEASED, get_db, get_job
...
def test_all_default_users_can_log_in(client):
    users = [
        ("admin", "change-me-admin", b"Active Jobs"),
        ("account", "change-me-account", b"Active Jobs"),
        ("warehouse", "change-me-warehouse", b"Active Jobs"),
        ("display", "change-me-display", b"Warehouse Orders"),
    ]
...
def test_warehouse_manager_cannot_release_on_hold_job_server_side(app, client):
    ...
    login(client, "warehouse", "change-me-warehouse")
